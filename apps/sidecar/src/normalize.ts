 ...
 *   無効化 / timeout 短縮) は自己弱化 pin が **pin describe の外側だけを触る単独編集の範囲で** RED にする
 *   (SEC-DB2R3-2・pin 自身を同時に書き換える coordinated 編集は通る・TDA-LN2-3)。**LINEAR metatest の seed 生成 / RATIO_MAX /
