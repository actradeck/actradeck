...
const ja = {
  ...
  "telemetry.retention.body":
    "収集先は届いた日次行をそのまま保持し、自動削除はありません。「停止してIDを削除」が消すのはこの端末のIDだけで、送信済みの行はサーバーに残ります。IDはサーバー側で秘密鍵付きハッシュとして保存され、運営者はどの行がどの端末のものか判別できません。送信済みの行の削除を求める場合は、IDを削除する前に、この画面に表示される匿名インストールIDを添えて運営者に依頼してください（IDを失うと行を特定できず削除できません）。ID再生成・再有効化後に送る行は、それ以前の行と結び付きません。",
  ...
  "audit.allow": "許可",
  "audit.pending": "保留",
  "audit.relayLostRetired": "中継喪失 取消",
  "audit.highRisk": "高リスク",
  ...
  "audit.detail.relayLostRetired": "取消 (中継喪失・自動整理)",
  ...
  "action.decision.allowForSession": "セッション許可",
  "action.decision.cancel": "取消",
...
const en: Record<MessageKey, string> = {
  ...
  "audit.relayLostRetired": "Relay-lost retired",
  ...
  "audit.detail.relayLostRetired": "cancelled (relay lost, auto-retired)",
  ...
  "action.decision.allowForSession": "allowed for session",
  "action.decision.cancel": "cancelled",
