...
const ja = {
  ...
  "approval.timeout.okMinutes": "自動拒否まで 約{minutes}分（安全側の推定）",
  ...
  "policy.cat.db-drop": "DB 削除（DROP / TRUNCATE / dropdb / mysqladmin drop / FLUSHALL）",
...
const en: Record<MessageKey, string> = {
  ...
  "approval.timeout.okMinutes": "Auto-deny in ~{minutes}m (fail-safe estimate)",
  ...
  "policy.cat.db-drop": "Database drop (DROP / TRUNCATE / dropdb / mysqladmin drop / FLUSHALL)",
