...
and the top-level `*.md` files are not matched by that glob, and no workflow in `.github/workflows/`
runs prettier, markdownlint or any other Markdown formatter over them. The exclusion is load-bearing,
